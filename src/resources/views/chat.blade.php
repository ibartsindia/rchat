...
<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <!--<link rel="apple-touch-icon" sizes="180x180" href="{{ asset('vendor/rchat/assets/img/apple-touch-icon.png') }}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('vendor/rchat//img/favicon-32x32.png') }}">
        <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('vendor/rchat//img/favicon-16x16.png') }}">-->
        <!-- Stylesheet -->
        <link rel="stylesheet" href="{{ asset('vendor/rchat//vendors/css/base/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ asset('vendor/rchat//vendors/css/base/elisyam-1.5.min.css') }}">
    ...
    <body id="page-top">
        ...
        <div id="preloader">
            <div class="canvas">
                <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="logo" class="loader-logo">
                ...
                <nav class="navbar fixed-top">       
                    ...
                    <div class="navbar-holder d-flex align-items-center align-middle justify-content-between">
                        ...
                        <div class="navbar-header">
                            <a href="db-default.html" class="navbar-brand">
                                <div class="brand-image brand-big">
                                    <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="logo" style="width: 70px;" class="logo-big">
                                </div>
                                <div class="brand-image brand-small">
                                    <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="logo" class="logo-small">
                                </div>
                            </a>
                            <!-- Toggle Button -->
                        ...
                        <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center pull-right">
                                ...
                                <ul aria-labelledby="notifications" class="dropdown-menu notification">
                                    <li>
                                        <div class="notifications-header">
                                            ...
                                            <img src="{{ asset('vendor/rchat//img/notifications/01.jpg') }}" alt="..." class="img-fluid">
                                        </div>
                                    </li>
                                    <li>
                                        <a href="#">
                            ...
                            <!-- End Notifications -->
                            <!-- User -->
                            <li class="nav-item dropdown"><a id="user" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link"><img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="..." class="avatar rounded-circle"></a>
                                <ul aria-labelledby="user" class="user-size dropdown-menu">
                                    <li class="welcome">
                                        <a href="#" class="edit-profil"><i class="la la-gear"></i></a>
                                        <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="..." class="rounded-circle">
                                    </li>
                                    <li>
                ...
                <div class="compact-sidebar has-shadow">
                    ...
                    <nav class="side-navbar box-scroll sidebar-scroll">
                        <ul class="list-unstyled">
                            <li>
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="text-white">All (34)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-eye-slash la-2x"></i>
                                    <span class="text-white">Unread (2)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-exclamation-triangle la-2x"></i>
                                    <span class="text-white">Important (4)</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="javascript:void(0)">
                                    ...
                                    <span class="text-white">Group (3)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-male la-2x"></i>
                                    <span class="text-white">Team (23)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-user la-2x"></i>
                                    <span class="text-white">Friends (8)</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-play la-2x"></i>
                                    <span class="text-white">Media (30)</span>
                                </a>
                            </li>
                        </ul>
                        <div class="sidebar-separator"></div>
                        <ul class="list-unstyled">
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-cog la-2x"></i>
                                    <span class="text-white">Settings</span>
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <i class="la la-question-circle la-2x"></i>
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="db-default.html">
                                    <i class="la la-angle-left la-2x"></i>
                                ...
                                <div class="row m-0 widget no-bg">
                                                        ...
                                                        <a class="d-block" data-toggle="tab" href="#msg-1">
                                                            <div class="media">
                                                                <div class="media-left align-self-center">
                                                                    <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" class="user-img rounded-circle" alt="...">
                                                                </div>
										            ...
										            <div class="card-body d-flex flex-column no-padding">
										                <div class="container-fluid">
										                    ...
										                    <div class="row m-0 justify-content-end">
                                                                ...
                                                                <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" class="avatar-bubble rounded-circle" alt="...">
										                    </div>
										                    <div class="row m-0 justify-content-end">
										                        <div class="message-card">
										                            <div class="card-body receiver-background">
                                    ...
                                    <div class="col-xl-2 p-0 chat-infos bg-white has-shadow">
                                        <div class="message-avatar">
                                            ...
                                            <img src="{{ asset('vendor/rchat//img/avatar/avatar-02-big.jpg') }}" class="img-fluid" alt="...">
                                        </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane show active fade" id="messenger" aria-labelledby="messenger-tab">
                                        ...
                                        <div class="messenger-message messenger-message-sender">
                                            <img class="messenger-image messenger-image-default" src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="...">
                                                ...
                                                <li class="list-group-item">
                                                    <div class="media">
                                                        <div class="media-left align-self-center mr-3">
                                                            <img src="{{ asset('vendor/rchat//img/avatar/avatar-02.jpg') }}" alt="..." class="img-fluid rounded-circle" style="width: 35px;">
                                                        </div>
                                                        <div class="media-body align-self-center">
        ...
        <!-- Begin Vendor Js -->
        <script src="{{ asset('vendor/rchat//vendors/js/base/jquery.min.js') }}"></script>
        <script src="{{ asset('vendor/rchat//vendors/js/base/core.min.js') }}"></script>
        <!-- End Vendor Js -->
        <!-- Begin Page Vendor Js -->
        <script src="{{ asset('vendor/rchat//vendors/js/nicescroll/nicescroll.min.js') }}"></script>
        <script src="{{ asset('vendor/rchat//vendors/js/app/app.min.js') }}"></script>
        <!-- End Page Vendor Js -->
        <!-- Begin Page Snippets -->
        <script src="{{ asset('vendor/rchat//js/app/chat/chat.min.js') }}"></script>
        <!-- End Page Snippets -->
    </body>
</html>